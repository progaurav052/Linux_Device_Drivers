...
__used __section(__versions) = {
	...
	{ 0xad25c7a, "of_match_device" },
	{ 0x6733450e, "_dev_info" },
	{ 0x681b8d06, "of_property_read_variable_u32_array" },
	{ 0xa8c297ec, "of_property_read_string" },
...
MODULE_INFO(srcversion, "3D345083FD24CFEA6ED57BD");
